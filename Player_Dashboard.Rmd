...
tradeServer <- function(input, output, session) {
  ...
  values <- reactiveValues(playersDatabase = playersPredictedStats_adjMin, playersExcluded = NULL)
  ...
  output$table_afterTrade <- renderDataTable({
    ...
    data <- filter(values$playersDatabase, Player %in% values$playersExcluded) %>%
