...
values <- reactiveValues(playersAdjMin = NULL, playersDatabase = NULL, playersRanks = NULL, teamsDatabase = NULL, teamsRanks = NULL, teamsStats = NULL, teamsMax = NULL, showTradeText = FALSE)
...
output$trade_popup <- renderUI({
  bsModal("modalTrade", paste0(Selected_Player()), "", size = "large",
          div(
            selectizeInput("tradeWhere", "Trade this player to:", choices = c("Retire",teamDashboard$Tm), selected = NULL),
