...
values <- reactiveValues(playersDatabase = NULL, playersRanks = NULL)
...
observeEvent(input$tradeButton, {
  ...
  isolate(values$playersDatabase <- filter(values$playersDatabase, Tm == "BOS"))
            #.trade_Players(values$playersDatabase,Selected_Player(),tmA=NULL, playB=NULL, tmB=NULL))
})
