...
- Fivethirtyeight: Player similarity by age
- Ayasdi: Data topology
- Andrew Gelman: model goals scored (something you can actually measure) not wins
- Neural Network package: R-blogger about NNet
