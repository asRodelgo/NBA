...
*Note: At the writing of this paper, rosters are not yet final so I will be using rosters as of the end of last season. In the paper I will update rosters and present predictions for the entire season."


require(stringr)
str_count(abstractText, "\\S+")
